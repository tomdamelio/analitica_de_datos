...
<!-- Mapa del curso: lo genera scripts/gen_mapa.py (regenerado en el deploy, y a mano
     con `python scripts/gen_mapa.py`) enlazando cada clase que ya tiene pagina.
     No editar el include a mano; editar la estructura en ese script. -->
